...
function YATT:CreateItemIndex(itemLink)
...
function YATT:CopyAddonSettings(isAccountWide, acctSettings, charSettings)
...
function YATT:AddCharacterToList(charList, charName)
...
function YATT:RemoveCharacterFromList(knownCharList, tgtCharName)
...
function YATT:RegisterCallback(event, callback)
